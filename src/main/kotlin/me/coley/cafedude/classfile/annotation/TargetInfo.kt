...
/**
 * @param targetTypeKind Info type, indicating the union layout. Abstraction of [.targetType].
 * @param targetType     Target type, the `target_type` of a `type_annotation`
 */ protected constructor(
    ...
    /**
     * @param targetType         Value of `target_type` of the enclosing `type_annotation`,
     * indicating the purpose of the `target_info`.
     * @param typeParameterIndex Index of the type parameter annotated.
     */(
        targetType: Int,
        /**
     ...
     * @param targetType     Value of `target_type` of the enclosing `type_annotation`,
     * indicating the purpose of the `target_info`.
     * @param superTypeIndex For `extends` index is 65535.
     ...
     * @param targetType         Value of `target_type` of the enclosing `type_annotation`,
     * indicating the purpose of the `target_info`.
     * @param typeParameterIndex Index of type parameter declaration.
     * @param boundIndex         Index of the bound of the parameter.
     */(
        targetType: Int,
        /**
     ...
     * indicating the purpose of the `target_info`.
     */
        (targetType: Int) : TargetInfo(TargetInfoType.EMPTY_TARGET, targetType) {
        override fun computeLength(): Int {
            return 0 // nothing
        }
    }
     ...
     * @param targetType           Value of `target_type` of the enclosing `type_annotation`,
     * indicating the purpose of the `target_info`.
     * @param formalParameterIndex Index of the formal parameter.
     */(
        targetType: Int,
        /**
     ...
     * @param targetType      Value of `target_type` of the enclosing `type_annotation`,
     * indicating the purpose of the `target_info`.
     * @param throwsTypeIndex Index of the thrown type in the associated `exception_index_table`
     ...
     * @param targetType    Value of `target_type` of the enclosing `type_annotation`,
     * indicating the purpose of the `target_info`.
     * @param variableTable The minimal local variable table of values annotated.
     */(
        targetType: Int,
        /**
        ...
        class Variable
        /**
         * @param startPc Initial offset in the code attribute the variable starts at.
         * @param length  Duration in the code attribute the variable persists for.
         * @param index   Index of the variable in the current frame's local variable array.
         */(
            /**
     ...
     * @param targetType          Value of `target_type` of the enclosing `type_annotation`,
     * indicating the purpose of the `target_info`.
     * @param exceptionTableIndex Index of exception parameter type.
     */(
        targetType: Int,
        /**
     ...
     * @param targetType Value of `target_type` of the enclosing `type_annotation`,
     * indicating the purpose of the `target_info`.
     * @param offset     Offset in the code attribute byte array of the annotated type instruction.
     */(
        targetType: Int,
        /**
     ...
     * indicating the purpose of the `target_info`.
     * @param offset            Offset in the code attribute byte array of the annotated type instruction.
     * @param typeArgumentIndex Index of the type in the cast operator that is annotated.
     */(
        targetType: Int,
        /**
         * @return Offset in the code attribute byte array of the annotated type instruction.
